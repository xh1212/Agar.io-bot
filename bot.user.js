...
function getLatestCommit() {
    window.jQuery.ajax({
            url: "https://api.github.com/repos/apostolique/choione.com-bot/git/refs/heads/master",
            cache: false,
            dataType: "jsonp"
        }).done(function(data) {
            ...
            $.get('https://raw.githubusercontent.com/Apostolique/choione.com-bot/master/bot.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                ...
                {
                    update("aposBot", "bot.user.js", "https://github.com/Apostolique/choione.com-bot/blob/" + sha + "/bot.user.js/");
                }
